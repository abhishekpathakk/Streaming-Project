...
orders_df = spark \
    .readStream \
    .format("kafka") \
    .option("kafka.bootstrap.servers", "pkc.azure.confluent.cloud:9092") \
    .option("subscribe", "orders_topic_data") \
    .option("startingOffsets", "latest") \
    .option("kafka.security.protocol", "SASL_SSL") \
    .option("kafka.sasl.mechanism", "PLAIN") \
    .option("kafka.sasl.jaas.config", "org.apache.kafka.common.security.plain.PlainLoginModule required username='VF' password='XmI5wYGkD0';") \
    .load() \
...
payments_df = spark \
    .readStream \
    .format("kafka") \
    .option("kafka.bootstrap.servers", "pkcazure.confluent.cloud:9092") \
    .option("subscribe", "payments_topic_data") \
    .option("startingOffsets", "latest") \
    .option("kafka.security.protocol", "SASL_SSL") \
    .option("kafka.sasl.mechanism", "PLAIN") \
    .option("kafka.sasl.jaas.config", "org.apache.kafka.common.security.plain.PlainLoginModule required username='V6SK4ZF' password='XmI\Pta/JQCH88+wHjkD0';") \
    .load() \
    .selectExpr("CAST(value AS STRING) as value") \
...
query = joined_df.writeStream \
    ...
    .option('spark.mongodb.connection.uri', "mongodb+srv://mrabr0.nyg0teg.mongodb.net/?w=majority&appName=Cluster0") \
